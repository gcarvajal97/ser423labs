...
public class JSONRPCServerConnection {
    ...
    public JSONRPCServerConnection(URL url, MainActivity parent) {
        this.url = url;
        this.parent = parent;
    ...
    public String call(String requestData) throws Exception {
        android.util.Log.d(this.getClass().getSimpleName(),"in call, url: "
                + url.toString()+" requestData: "+requestData);
